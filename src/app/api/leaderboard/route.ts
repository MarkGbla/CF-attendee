...
export async function GET() {
  try {
    ...
    // Sort by score descending, then by sessions present, then name
    leaderboard.sort((a, b) => {
      if (b.score !== a.score) return b.score - a.score;
      if (b.sessionsPresent !== a.sessionsPresent)
        return b.sessionsPresent - a.sessionsPresent;
    ...
    return NextResponse.json({ entries: ranked, totalSessions });
  } catch {
